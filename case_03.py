...
try:
    ...
    input3.send_keys("ЁЁщщШ -щЁ- ЁЁщ-щШ Ё-Ё- Ё-Ё ШЁЁЁ-ЁщщШ-щщ--щ --ЁщШ щЁщщ-ШЁщШЁщ щщщ  Ш  ЁЁщШщщШШШ ЁШЁЁ ШШШЁ-Ш щШ   ЁШщ-")
    input4 = browser.find_element_by_name("name")
    input4.send_keys("ЁЁщщШ -щЁ- ЁЁщ-щШ Ё-Ё- Ё-Ё ШЁЁЁ-ЁщщШ-щщ--щ --ЁщШ щЁщщ-ШЁщШЁщ щщщ  Ш  ЁЁщШщщШШШ ЁШЁЁ ШШШЁ-Ш щШ   ЁШщ-")
    input5 = browser.find_element_by_name("middlename")
    input5.send_keys("ЁЁщщШ -щЁ- ЁЁщ-щШ Ё-Ё- Ё-Ё ШЁЁЁ-ЁщщШ-щщ--щ --ЁщШ щЁщщ-ШЁщШЁщ щщщ  Ш  ЁЁщШщщШШШ ЁШЁЁ ШШШЁ-Ш щШ   ЁШщ-")
    input6 = browser.find_element_by_name("mobile")
    input6.send_keys("9111260565")
